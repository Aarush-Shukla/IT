// Keywords to identify Problems based on the Sliding Window.
...
// - Problems contain a Window Size and We have to Find the Maximum or Minimum Condition(or Value).
// - Problems are usually Easy.

// 2. Variable Size Sliding Window
// - In this Window size is Variable.
// - Problems contain a Condition (or Value) and We have to Find the possible size of Window (mostly Largest or Smallest Window Size).
// - Problems are usually Hard.

// Important Note on Types of Sliding Window:

// 1. In Fix Size Sliding Window problems --> Window size is given and we have to find Maximize or Minimize Condition (or Value)
// 2. In Varible Size Sliding Window problems --> Condition (or Value) is given and we have to Find the possible size of Window (Largest or Smallest).
